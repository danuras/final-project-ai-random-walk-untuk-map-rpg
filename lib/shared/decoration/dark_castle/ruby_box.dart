...
import 'package:final_project_ai/shared/item/ruby_ingot.dart';

class BigIronBox extends SimpleEnemy
    with ObjectCollision, AutomaticRandomMovement {
  BigIronBox(Vector2 position)
      : super(
          position: position,
          animation: SimpleDirectionAnimation(
            idleRight: SpriteAnimation.load(
              "decoration/dark_castle/ruby_box.png",
            ...
            runRight: SpriteAnimation.load(
              "decoration/dark_castle/big_iron_box.png",
              SpriteAnimationData.sequenced(
                amount: 1,
                stepTime: 10,
                textureSize: Vector2(32, 32),
  ...
  void die() {
    animation?.playOnce(
      SpriteAnimation.load(
        "decoration/dark_castle/box_ancur.png",
        SpriteAnimationData.sequenced(
          amount: 4,
          stepTime: 0.1,
    ...
    gameRef.add(RubyIngot(position, 30));
    super.die();
  }
/* 
  @override
