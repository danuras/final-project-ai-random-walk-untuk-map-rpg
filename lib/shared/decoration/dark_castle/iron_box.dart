...
import 'package:final_project_ai/shared/item/iron_ingot.dart';
import 'package:final_project_ai/shared/item/potion_life.dart';

class IronBox extends SimpleEnemy
    with ObjectCollision, AutomaticRandomMovement {
  IronBox(Vector2 position)
      : super(
          position: position,
          animation: SimpleDirectionAnimation(
            idleRight: SpriteAnimation.load(
              "decoration/dark_castle/iron_box.png",
  ...
  void die() {
    ...
    gameRef.add(IronIngot(position, 30));
    super.die();
  }
/* 
  @override
