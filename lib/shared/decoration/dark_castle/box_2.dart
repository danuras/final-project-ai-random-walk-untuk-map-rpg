...
class Box2 extends SimpleEnemy with ObjectCollision, AutomaticRandomMovement {
  Box2(Vector2 position)
      : super(
          position: position,
          animation: SimpleDirectionAnimation(
            idleRight: SpriteAnimation.load(
              "decoration/dark_castle/box_2.png",
  ...
  void die() {
    animation?.playOnce(
      SpriteAnimation.load(
        "decoration/dark_castle/box_2_ancur.png",
        SpriteAnimationData.sequenced(
          amount: 4,
          stepTime: 0.1,
